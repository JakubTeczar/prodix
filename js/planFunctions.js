...
//     creatingPanelTitle.value = currentFillPlan.title;
//     creatingPanelDescription.value = currentFillPlan.description;
                ...
                this.elements.forEach(el => {
                    ...
                    if (el.elements){
                        copy.addEventListener("click", ()=>{
                            ...
                            showSet.querySelector(".show-set__title").textContent = el.title;
...
const saveOnDBHistory = ()=>{
    ...
    if (planHistory[0].length > 3){
        newList.push(planHistory[0].pop());
        newList.push(planHistory[0].pop());
        newList.push(planHistory[0].pop());
